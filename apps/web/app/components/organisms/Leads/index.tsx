...
import { Box, Grid, Flex, Text, Input } from '@chakra-ui/react';
import { COLORS, SearchIco } from '../../atoms';
import { Lead, LeadKanbanBoard } from './LeadKanbanBoard';
import AppLayout from '../../template/general-layout';
import { PageTopBar } from '../../molecules';
import { PlatformPerformanceTable } from '../analytics/PlatformPerformanceTable';
import { LeadSourcesPie } from '../analytics/LeadSourcesPie';
