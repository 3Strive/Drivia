...
import { Box, Grid, Image, Text, Flex, HStack } from '@chakra-ui/react';
...
export const InventoryCarGrid = ({
  cars,
  onEdit,
  onDelete,
}: InventoryCarGridProps) => (
  <Grid
    ...
    {cars.map((car) => (
      ...
      >
        <Box position="relative" h="160px">
          <Image src={car.images[0]} w="100%" h="100%" objectFit="cover" />
        ...
        <Box p="14px">
          ...
          <Flex justify="space-between" align="center" mb="12px">
            ...
            <HStack gap="10px">
              ...
              <HStack gap="3px">
                <Box color="gray.400" fontSize="11px">
                  💬
                </Box>
                <Text fontSize="11px" color="gray.500">
                  {car.enquiries}
