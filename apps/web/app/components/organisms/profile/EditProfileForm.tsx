...
export const EditProfileForm = ({ initial, onSave }: EditProfileFormProps) => {
  ...
  const set = (k: keyof ProfileFormData, v: string) =>
    setForm((p) => ({ ...p, [k]: v }));
    ...
    >
      ...
      <Flex align="center" gap="16px" mb="24px">
        ...
        <Box>
          ...
          <Text fontSize="11px" color="gray.400" mt="2px">
            PNG or JPG · Max 2MB · 200×200px recommended
          </Text>
        </Box>
      </Flex>
      ...
      <Grid templateColumns="1fr 1fr" gap="14px">
        {[
          {
            label: 'Business Name',
            key: 'businessName',
            placeholder: 'e.g. Eko Motors Ltd',
          },
          {
            label: 'Owner Name',
            key: 'ownerName',
          ...
          <VStack key={f.key} align="start" gap="4px">
            ...
            <Input
              ...
              onChange={(e) =>
                set(f.key as keyof ProfileFormData, e.target.value)
              }
              borderRadius="10px"
              fontSize="13px"
              p={3}
        ...
        <VStack align="start" gap="4px" gridColumn="1 / -1">
          ...
          <Textarea
            placeholder="Tell buyers about your dealership — specialties, years in business, what makes you different..."
            value={form.bio}
