...
import { BroadcastCampaign } from '../../../shared/types';
...
export const BroadcastHistoryList = ({
  campaigns,
  ...
  >
    ...
    <Grid templateColumns="2.5fr 1fr 1fr 1fr 1fr 80px" gap="0">
      {['Message', 'Channels', 'Reach', 'Opened', 'Replies', 'Status'].map(
        (h) => (
          <Text
            key={h}
            fontSize="10px"
