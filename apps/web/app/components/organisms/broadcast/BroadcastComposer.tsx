  ...
  return (
    ...
    >
      ...
      <Text fontSize="12px" color="gray.400" mb="16px">
        Send a message to all your contacts on selected platforms
      </Text>
      ...
      />
      <Text fontSize="11px" color="gray.400" mb="16px">
        ...
        <HStack gap="6px">
          {['now', 'later'].map((s) => (
            ...
            >
              {s === 'now' ? (
                <HStack gap="6px">
                  <FaBolt color={'red'} size={16} />
                  <span>Send Now</span>
                </HStack>
              ) : (
                <HStack gap="6px">
                  <FaClock color={COLORS.white} size={16} />
                  <span>Schedule</span>
                </HStack>
              )}
            </Box>
