...
const PLATFORMS = [
  {
    ...
    icon: <FaFacebook />,
    desc: 'Post listings and receive DMs',
  },
  {
    key: 'instagram',
    ...
    icon: <FaInstagram />,
    desc: 'Share photos and story posts',
  },
  {
    key: 'whatsapp',
    ...
    icon: <FaWhatsapp />,
    desc: 'Auto-replies and broadcasts',
  },
];
...
export const PlatformConnector = ({
  ...
  >
    ...
    <Text fontSize="12px" color="gray.400" mb="16px">
      Link your social accounts to post directly from Drivia
    </Text>
      ...
      {PLATFORMS.map((p) => {
        ...
        return (
          <Box
            ...
            borderRadius="14px"
            border="2px solid"
            borderColor={isConnected ? p.color : 'gray.150'}
          ...
          >
            <Flex align="center" justify="space-between" mb="8px">
              <Flex
                ...
                justify="center"
              >
                <Text fontSize="12px" color="white" fontWeight="900">
                  {p.icon}
                </Text>
              </Flex>
              {isConnected && (
            ...
            <Text fontSize="13px" fontWeight="700" color="gray.800" mb="3px">
              {p.label}
            </Text>
            <Text fontSize="11px" color="gray.500" mb="12px">
              {p.desc}
            </Text>
            <Button
              w="100%"
              ...
              _hover={{ opacity: 0.9 }}
              onClick={() =>
                isConnected ? onDisconnect(p.key) : onConnect(p.key)
              }
            >
